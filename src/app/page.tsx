  ...
  return (
    <div className="py-20 flex flex-col items-center bg-amber-50 h-screen px-18">
      ...
      <div>
        ...
        I am a 14 year old from Vidisha. I really doesn't have a fav language and love to try almost everything from 3D modelling to functional programming and linux.
        </p>
